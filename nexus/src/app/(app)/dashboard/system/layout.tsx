...
export default function SystemLayout({ children }: { children: React.ReactNode }) {
  ...
  // Node picker is per-node-settings scoped. /dashboard/system/updates is
  // cluster-scoped (Nexus release policy, not a PVE node setting), so we
  // suppress the picker there — otherwise it renders as an irrelevant
  // no-op control at the top of the Updates page.
  const showNodePicker = pathname !== '/dashboard/system/updates';
