...
function StepConfirm({ state }: { state: WizardState }) {
  ...
  return (
    <div className="space-y-2">
      <p className="text-sm text-[var(--color-fg-muted)] mb-4">Review your settings before creating the VM.</p>
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        <button onClick={() => router.push('/dashboard/vms')} className="text-[var(--color-fg-subtle)] hover:text-[var(--color-fg-secondary)] transition">
