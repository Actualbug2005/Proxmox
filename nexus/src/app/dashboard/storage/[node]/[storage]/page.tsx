  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-2 text-sm">
        <Link href="/dashboard/storage" className="flex items-center gap-1 text-gray-500 hover:text-gray-300 transition">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              ...
              <span className="ml-1 text-gray-600">· node <span className="font-mono">{node}</span></span>
            </p>
          </div>
        </div>
        {canUpload && (
