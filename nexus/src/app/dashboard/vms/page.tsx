            ...
            <tbody className="divide-y divide-gray-800/60">
              {sorted.map((vm) => {
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3 text-sm font-mono text-gray-400">{vm.vmid}</td>
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <Monitor className="w-3.5 h-3.5 text-gray-600 shrink-0" />
                    ...
                    <td className="px-4 py-3 text-sm text-gray-400">{vm.node}</td>
                    ...
                    <td className="px-4 py-3 w-32">
                      {vm.maxdisk ? (
                        <div>
                          <span className="text-xs text-gray-400 tabular-nums">
                            {formatBytes(vm.disk ?? 0)} / {formatBytes(vm.maxdisk)}
                          </span>
