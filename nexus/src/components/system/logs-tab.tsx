 ...
 * Node Logs tab body.
 *
 * Extracted from `src/app/(app)/dashboard/system/logs/page.tsx` for the
 ...
 *
 * No URL sub-tabs — the Table / Live-Tail segmented toggle is a local
 * view-mode switch driven by local state (not a persistent deep-link
 * surface). The tail viewer uses a fixed `h-[28rem]` so there is no
 * viewport-ancestor layout contract for the Task 2 shell to provide.
 */
