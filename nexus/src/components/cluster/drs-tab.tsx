 ...
 * Auto-DRS tab body.
 *
 * Extracted from `src/app/(app)/dashboard/cluster/drs/page.tsx` for the
 * Plan C Task 2 tabbed shell. DRS has no internal sub-tabs — the mode
 * + knobs + history all live on one page — so no ?sub= wiring here.
 *
