    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className={inputCls}
            />
            <p className="text-xs text-gray-600 mt-1">{'PVE template vars: {{guestname}} {{node}} {{vmid}}'}</p>
          </div>
        ...
        <div className="flex gap-3 justify-end mt-5">
          <button onClick={onClose} disabled={backupM.isPending} className="px-4 py-2 text-sm text-gray-400 hover:text-white bg-gray-800 rounded-lg transition disabled:opacity-40">
            Cancel
          </button>
          <button
            onClick={submit}
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {files.map((f) => (
                  <tr key={f.volid} className="border-b border-gray-800/40 hover:bg-gray-800/20">
                    ...
                    <td className="px-4 py-2 text-right">
                      <div className="flex gap-1 justify-end">
                        ...
                        <button
                          ...
                          className={cn(
                            'flex items-center gap-1.5 px-2.5 py-1 text-xs bg-gray-800 hover:bg-gray-700 rounded-lg transition disabled:opacity-40',
                            f.protected ? 'text-yellow-400' : 'text-gray-400',
                          )}
