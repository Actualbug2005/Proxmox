      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800">
          <div>
            ...
            <p className="text-xs text-gray-500">on {node}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-4">
          ...
          {/* Protocols */}
          <div>
            <label className="text-xs text-gray-500 block mb-2">Protocols</label>
            <div className="flex gap-3">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-300">SMB</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 accent-orange-500"
                />
                <span className="text-sm text-gray-300">NFS</span>
              </label>
            </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-800">
            <div>
              <p className="text-sm text-gray-300">Read-only</p>
            ...
            <button
              ...
              className={cn(
                ...
                readOnly ? 'bg-emerald-500' : 'bg-gray-700',
              )}
            >
              <span
                className={cn(
