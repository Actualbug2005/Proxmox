    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
        ...
        <div className="space-y-3">
          <div>
            <label className="text-xs text-gray-500 block mb-1">Resource (SID)</label>
            {isEdit ? (
          ...
          <div>
            <label className="text-xs text-gray-500 block mb-1">Desired state</label>
          ...
          <div>
            <label className="text-xs text-gray-500 block mb-1">Group (optional)</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 block mb-1">Max restart</label>
              <input type="number" min={0} value={maxRestart} onChange={(e) => setMaxRestart(e.target.value)} className={inputCls} />
            </div>
            <div>
              <label className="text-xs text-gray-500 block mb-1">Max relocate</label>
