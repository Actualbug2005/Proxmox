...
This project is indexed by GitNexus as **Proxmox** (684 symbols, 1498 relationships, 38 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
