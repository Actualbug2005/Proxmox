...
This project is indexed by GitNexus as **Proxmox** (1055 symbols, 2710 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
