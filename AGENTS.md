...
This project is indexed by GitNexus as **Proxmox** (1259 symbols, 3160 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
