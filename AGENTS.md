...
This project is indexed by GitNexus as **Proxmox** (1309 symbols, 3386 relationships, 104 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
