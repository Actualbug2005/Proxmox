...
This project is indexed by GitNexus as **Proxmox** (894 symbols, 2246 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
