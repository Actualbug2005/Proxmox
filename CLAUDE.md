...
This project is indexed by GitNexus as **Proxmox** (927 symbols, 2362 relationships, 73 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
