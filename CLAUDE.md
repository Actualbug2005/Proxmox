...
This project is indexed by GitNexus as **Proxmox** (910 symbols, 2299 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
