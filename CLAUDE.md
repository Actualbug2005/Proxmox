...
This project is indexed by GitNexus as **Proxmox** (1208 symbols, 3039 relationships, 96 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
