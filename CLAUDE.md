...
This project is indexed by GitNexus as **Proxmox** (938 symbols, 2419 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
