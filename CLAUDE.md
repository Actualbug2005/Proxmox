...
This project is indexed by GitNexus as **Proxmox** (961 symbols, 2450 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
