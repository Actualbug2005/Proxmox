...
This project is indexed by GitNexus as **Proxmox** (1014 symbols, 2588 relationships, 81 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
